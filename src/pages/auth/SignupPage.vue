    ...
    <div class="hidden md:flex flex-col justify-between w-[40%] h-screen bg-surface-container-lowest p-margin-desktop relative border-r border-outline anim-slide-right" id="left-panel">
      ...
      <div class="z-10 max-w-md">
        <h1 class="font-display-lg text-display-lg-mobile md:text-display-lg text-on-surface leading-tight">
          Craft premium spaces<br/>
          <span class="text-on-surface-variant">for client collaboration.</span>
        </h1>
      </div>
    ...
    <div class="w-full md:w-[60%] flex-1 flex flex-col justify-center items-center p-margin-mobile md:p-margin-desktop bg-background relative anim-fade-in" id="right-panel" style="transition-delay: 400ms;">
      <div class="w-full max-w-[420px] flex flex-col gap-10">
        ...
        <div class="stagger-item anim-fade-up">
          <h2 class="font-headline-lg text-headline-lg text-on-surface mb-2">Create your account</h2>
          <p class="font-body-md text-body-md text-on-surface-variant">Get started with ClientOS for free.</p>
        </div>
        ...
        <form class="flex flex-col gap-8 w-full" @submit.prevent="handleSubmit">
          <div class="flex flex-col gap-6">
            ...
            <div class="input-focus-border stagger-item anim-fade-up" style="transition-delay: 80ms;">
              ...
              />
              <span v-if="fullNameError && formSubmitted" class="text-xs text-error mt-1 block">{{ fullNameError }}</span>
            </div>
            ...
            <!-- Password -->
            <div class="input-focus-border stagger-item anim-fade-up" style="transition-delay: 240ms;">
              <input
                v-model="password"
                type="password"
        ...
        <div class="text-center mt-6 stagger-item anim-fade-up" style="transition-delay: 560ms;">
          <p class="font-body-md text-body-md text-on-surface-variant">
            ...
            <router-link to="/login" class="text-primary hover:text-primary-container transition-colors ml-1 font-medium border-b border-transparent hover:border-primary pb-0.5">Sign In</router-link>
          </p>
        </div>
      </div>
    </div>
